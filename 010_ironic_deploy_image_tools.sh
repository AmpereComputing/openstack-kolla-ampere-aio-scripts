...
apt-get update -y && apt-get install ipmitool qemu-utils kpartx hdparm  util-linux squashfs-tools genisoimage debootstrap qemu-block-extra uuid-runtime shellinabox socat debian-installer-10-netboot-arm64 -y 
